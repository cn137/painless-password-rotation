...
Unlisted Contribution Credit:
* [Sean Carolan](https://github.com/scarolan/painless-password-rotation) - Most of the code has been taken from his repository and modified.   
* [Seth Vargo](https://github.com/sethvargo/vault-secrets-gen) - For creating the plugins that allows all of this to work.   
...
#### 2. Run password rotation service
```bash
systemctl start rotate-password.service
```

#### 3. Log onto the Vault UI and verify that the password was saved successfully   

#### 4. Start/Enable password rotation timer
```bash
